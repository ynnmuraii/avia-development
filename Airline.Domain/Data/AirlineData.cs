...
public class AirlineData
{
    ...
    /// <summary>
    /// Конструктор класса AirlineData, инициализирующий коллекции тесттовыми данными.
    /// </summary>
    public AirlineData()
    {
        ...
        Flights = new List<Flight>
        {
            new()
            {
                ...
                TimeOfDeparture = new TimeOnly(8, 30),
            ...
            new()
            {
                ...
                TimeOfDeparture = new TimeOnly(14, 00),
            ...
            new()
            {
                ...
                TimeOfDeparture = new TimeOnly(9, 45),
            ...
            new()
            {
                ...
                DateOfDeparture = new DateOnly(2025, 10, 23),
                DateOfArrival = new DateOnly(2025, 10, 23),
                TimeOfDeparture = new TimeOnly(11, 15),
            ...
            new()
            {
                ...
                TimeOfDeparture = new TimeOnly(7, 50),
            ...
            new()
            {
                ...
                TimeOfDeparture = new TimeOnly(13, 40),
            ...
            new()
            {
                ...
                From = "LED",
                To = "SVO",
                DateOfDeparture = new DateOnly(2025, 10, 26),
                DateOfArrival = new DateOnly(2025, 10, 26),
                TimeOfDeparture = new TimeOnly(15, 10),
                FlightDuration = TimeSpan.FromHours(1.3),
                Model = Models[6]
            },
            ...
            new()
            {
                ...
                From = "SVO",
                To = "AER",
                DateOfDeparture = new DateOnly(2025, 10, 27),
                DateOfArrival = new DateOnly(2025, 10, 27),
                TimeOfDeparture = new TimeOnly(16, 00),
            ...
            new()
            {
                ...
                From = "SVO",
                To = "SVX",
                DateOfDeparture = new DateOnly(2025, 10, 28),
                DateOfArrival = new DateOnly(2025, 10, 28),
                TimeOfDeparture = new TimeOnly(12, 15),
            ...
            new()
            {
                ...
                From = "LED",
                To = "KZN",
                DateOfDeparture = new DateOnly(2025, 10, 29),
                DateOfArrival = new DateOnly(2025, 10, 29),
                TimeOfDeparture = new TimeOnly(6, 50),
